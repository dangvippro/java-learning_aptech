...
public class TransferLetter extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnCreateLetter.setText("Cretate Transfer Letter");
    ...
    private void btnCreateLetterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateLetterActionPerformed
        String empNumber="", fullname = "", cPro="", cDep="";
        while (true) {
            try {
        ...
        lblFullname2.setText(fullname);
        lblFullname3.setText(fullname);
        lblFullname4.setText(fullname);
        lblFullname5.setText(fullname);
        lblDateOfPosting.setText(ft.format(new Date()));
        lblRelievingDate.setText(ft.format(txtRelievingDate.getDate()));
        lblJoiningDate.setText(ft.format(txtJoiningDate.getDate()));
        lblCPro.setText(cPro);
        lblTPro.setText((String) cbTPro.getSelectedItem());
        lblTPos.setText((String) cbTPos.getSelectedItem());
        lblCDep.setText(cDep);
        
        transfer_letter.setSize(972, 600);
        transfer_letter.setVisible(true);
