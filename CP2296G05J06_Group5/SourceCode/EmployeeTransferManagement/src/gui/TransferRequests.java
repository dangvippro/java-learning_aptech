...
public class TransferRequests extends javax.swing.JFrame {
   ...
   public TransferRequests(String empNumber) {
    ...
    private void initComponents() {
        ...
        lblAllowanceLevel = new javax.swing.JLabel();
        ...
        lblAllowanceLevel.setText("Allowance Level");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(cbTPro, 0, 247, Short.MAX_VALUE)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addGroup(layout.createSequentialGroup()
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(cbStatus, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 247, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(lblAllowanceLevel, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(txtAllowanceLevel, javax.swing.GroupLayout.PREFERRED_SIZE, 247, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(82, 82, 82))
        );
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(lblAllowanceLevel)
                                .addGap(45, 45, 45)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    .addComponent(btnSearch, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(btnReset, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(txtAllowanceLevel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE))))
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(lblReason)
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        if (cbTPro.getSelectedItem() == null && cbTDep.getSelectedItem() == null && cbTPos.getSelectedItem() == null && cbStatus.getSelectedItem() == null) {
            ...
            try {
            con = db.getCon();
            ps = con.prepareStatement("SELECT req.transferRequestNumber, e.fullname, e.dateOfBirth, req.cProject, tPro.transferProjectName, req.cDepartment, Dep.transferDepartmentName, req.cPosition, Pos.transferPositionName, Pos.allowanceLevel, req.reason, req.transferRelievingDate, req.transferJoiningDate, req.dateOfPosting, req.approvalDate, req.[status] FROM TransferRequests AS req INNER JOIN Employee AS e ON req.empNumber = e.empNumber INNER JOIN TransferProject AS tPro ON req.transferProjectNumber = tPro.transferProjectNumber INNER JOIN TransferDepartment AS Dep ON Req.transferDepartmentNumber = Dep.transferDepartmentNumber INNER JOIN TransferPosition AS Pos ON req.transferPositionNumber = Pos.transferPositionNumber WHERE req.empNumber = ? AND (tPro.transferProjectName LIKE ? AND Dep.transferDepartmentName LIKE ? AND Pos.transferPositionName LIKE ? AND req.[status] LIKE ? AND req.reason LIKE ? AND Pos.allowanceLevel LIKE ?)");
            ps.setString(1, lblEmpNumber.getText());
            if (cbTPro.getSelectedIndex() == -1) {
                ps.setString(2, "%");
            } else {
               ps.setString(2, (String) cbTPro.getSelectedItem() + "%"); 
            }
            if (cbTDep.getSelectedIndex() == -1) {
                ps.setString(3, "%");            
            } else {
                ps.setString(3, (String) cbTDep.getSelectedItem() + "%");
            }

            if (cbTPos.getSelectedIndex() == -1) {
                ps.setString(4, "%");
            } else {
                ps.setString(4, (String) cbTPos.getSelectedItem() + "%");
            }
            ...
            if (txtaReason.getText().trim().equals("")) {
                ps.setString(6, "%");
            } else {
                ps.setString(6, txtaReason.getText() + "%");
            }
            if (txtAllowanceLevel.getText().trim().equals("")) {
                ps.setString(7, "%");
            } else {
                ps.setString(7, txtAllowanceLevel.getText() + "%");
            }
            rs = ps.executeQuery();
            row = new Vector();
    ...
    private javax.swing.JLabel lblAllowanceLevel;
